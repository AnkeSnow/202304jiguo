...
more.onclick = function () {
    ...
    setTimeout(function () {
        ...
        document.getElementsByTagName('article')[0].firstElementChild.children[25].style.display = 'block';
        document.getElementsByTagName('article')[0].firstElementChild.children[24].style.display = 'block';
        document.getElementsByTagName('article')[0].firstElementChild.children[23].style.display = 'block';
        document.getElementsByTagName('article')[0].firstElementChild.children[22].style.display = 'block';
    }, 3000)
}
// ajax
